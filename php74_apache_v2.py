...
os.system('cd /etc/yum.repos.d && wget --no-check-certificate https://repo.codeit.guru/codeit.el`rpm -q --qf "%{VERSION}" \$(rpm -q --whatprovides redhat-release)`.repo')
os.system('echo "sslverify=0" >> /etc/yum.repos.d/codeit.el7.repo')
